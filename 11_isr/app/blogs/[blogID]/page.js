...
export const dynamicParams = false; //this hiders the creation of new pages
export const revalidate = 5; // this will disable the ISR and the page will be generated only at build time and will not be revalidated at runtime
// export const revalidate = false; // this will disable the ISR and the page will be generated only at build time and will not be revalidated at runtime
...
export async function generateStaticParams() {
    ...
    try {
        ...
        console.log("Failed to fetch todos, using fallback params", error);
